...
from armasec_core.openid_config_loader import OpenidConfigLoader
from armasec_core.schemas.armasec_config import DomainConfig
from armasec_core.schemas.jwks import JWK, JWKs
...
@pytest.fixture()
def rs256_secondary_domain():
    """
    Provide a fixture that returns a secondary domain for use in other fixtures.

    The value here doesn't really have anything to do with an actual domain name.
    """
    return "secondary.armasec.dev"
...
@pytest.fixture()
def rs256_secondary_domain_config(rs256_secondary_domain):
    """
    Provide a fixture that returns a secondary DomainConfig model.
    """
    return DomainConfig(domain=rs256_secondary_domain, audience="https://this.api")
